 ...
 * mostrar la sección de Términos y Condiciones en Crear Voluntariado.
 */
...
export default class KTeryCon extends Component {
	...
	/**
	 * El botón de Crear Campaña se deshabilita si no se escribe nada
	 * en Términos y Condiciones. Este método lo habilita cuando
	 * se hay escrito algo.
	 */
	...
	/*
	* Componente donde se escriben los términos y condiciones
	*/
	termsAndConditions() {
